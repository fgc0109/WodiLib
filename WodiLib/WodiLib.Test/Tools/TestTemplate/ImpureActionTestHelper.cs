...
namespace WodiLib.Test.Tools
{
    ...
    internal class ImpureActionTestHelper : ImpureTestHelperBase
    {
        ...
        /// </param>
        /// <typeparam name="TTarget">テスト対象型</typeparam>
        public void ImpureActionFailure<TTarget>(
            TTarget instance,
            Action<TTarget> execAction,
        ...
        private void ImpureActionInternal<TTarget>(
            TTarget instance,
            Action<TTarget> execAction,
