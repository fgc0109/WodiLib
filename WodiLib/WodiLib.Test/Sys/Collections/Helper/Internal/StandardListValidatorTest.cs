...
{
    [TestFixture]
    public class CommonListValidatorTest : TestFixtureBase
    {
        [SetUp]
        ...
        private static StandardListValidator<IStubRestrictedCapacityListSettings, IStubModelSettings> GetTestInstance(
            int count = TestData.INIT_LENGTH
        )
        {
            return new StandardListValidator<IStubRestrictedCapacityListSettings, IStubModelSettings>(
                countGetter: () => count
            );
        }
