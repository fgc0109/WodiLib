...
{
    [TestFixture]
    public class RestrictedCapacity2DListValidatorTest
    {
        ...
        private static RestrictedCapacity2DListValidator<IStubRestrictedCapacityListSettings, IStubModelSettings>
            GetTestInstance(
