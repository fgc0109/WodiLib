...
{
    [TestFixture]
    public class DatabaseDataNameListTest : TestFixtureBase
    {
        [SetUp]
        ...
        public static void MaxCapacityTest()
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseDataNameList.MaxCapacity,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseDataNameList.MinCapacity,
        ...
        public static void ConstructorTest_NoParam_Success()
        {
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseDataNameList(),
                instanceVerifier: ValueVerifier<DatabaseDataNameList>.AreItemEquals(new DatabaseDataNameListSettings())
            );
        }
        ...
        public static void ConstructorTest_SettingsDto_Success()
        {
            ...
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseDataNameList(settings),
                instanceVerifier: ValueVerifier<DatabaseDataNameList>.AreItemEquals(settings)
            );
        }
        ...
        {
            IDatabaseDataNameListSettings settings = null!;
        ...
        {
            var left = new DatabaseDataNameList(CreateSettingsDto());
            IDatabaseDataNameListSettings right = left;
        ...
        {
            var left = new DatabaseDataNameList(CreateSettingsDto());
            IDatabaseDataNameListSettings right = CreateSettingsDto();
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: true
        ...
        {
            var left = new DatabaseDataNameList(CreateSettingsDto());
            IDatabaseDataNameListSettings? right = null;
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var left = new DatabaseDataNameList(CreateSettingsDto());
            IDatabaseDataNameListSettings right = CreateSettingsDto(hasNullItem: true);
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var instance = new DatabaseDataNameList(CreateSettingsDto());
        ...
        {
            constructorTestHelper.ConstructorSuccess(
                () => new DatabaseDataNameListSettings(),
                instanceVerifier: new ValueVerifier<DatabaseDataNameListSettings>(instance =>
                    {
                        // 要素数が最小であること
                        Assert.AreEqual(DatabaseDataNameList.MinCapacity, instance.Settings.Count);
                    }
                )
            );
        }
        ...
        /// </param>
        /// <returns></returns>
        private static DatabaseDataNameListSettings CreateSettingsDto(
            int itemLength = 4,
        ...
        /// </param>
        /// <returns></returns>
        private static DataName CreateSettingsItem(
            int index,
