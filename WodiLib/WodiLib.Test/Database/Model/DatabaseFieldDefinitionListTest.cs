...
{
    [TestFixture]
    public class DatabaseFieldDefinitionListTest : TestFixtureBase
    {
        [SetUp]
        ...
        public static void MaxCapacityTest()
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseFieldDefinitionList.MaxCapacity,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseFieldDefinitionList.MinCapacity,
        ...
        public static void ConstructorTest_NoParam_Success()
        {
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseFieldDefinitionList(),
                instanceVerifier: ValueVerifier<DatabaseFieldDefinitionList>.AreItemEquals(
        ...
        public static void ConstructorTest_SettingsDto_Success()
        {
            ...
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseFieldDefinitionList(settings),
                instanceVerifier: ValueVerifier<DatabaseFieldDefinitionList>.AreItemEquals(settings)
            );
        }
        ...
        {
            IDatabaseFieldDefinitionListSettings settings = null!;
        ...
        {
            var left = new DatabaseFieldDefinitionList(CreateSettingsDto());
            IDatabaseFieldDefinitionListSettings right = left;
        ...
        {
            var left = new DatabaseFieldDefinitionList(CreateSettingsDto());
            IDatabaseFieldDefinitionListSettings right = CreateSettingsDto();
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: true
        ...
        {
            var left = new DatabaseFieldDefinitionList(CreateSettingsDto());
            IDatabaseFieldDefinitionListSettings? right = null;
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var left = new DatabaseFieldDefinitionList(CreateSettingsDto());
            IDatabaseFieldDefinitionListSettings right = CreateSettingsDto(hasNullItem: true);
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var instance = new DatabaseFieldDefinitionList(CreateSettingsDto());
        ...
        public static void SettingsDtoConstructorTest_Success_NoParam()
        {
            constructorTestHelper.ConstructorSuccess(
                () => new DatabaseFieldDefinitionListSettings(),
                instanceVerifier: new ValueVerifier<DatabaseFieldDefinitionListSettings>(instance =>
                    {
                        // 要素数が最小であること
                        Assert.AreEqual(DatabaseFieldDefinitionList.MinCapacity, instance.Settings.Count);
                    }
                )
            );
        }
        ...
        /// </param>
        /// <returns></returns>
        private static DatabaseFieldDefinitionListSettings CreateSettingsDto(
            int itemLength = 4,
        ...
        /// </param>
        /// <returns></returns>
        private static IDatabaseFieldDefinitionSettings CreateSettingsItem(
            int index,
        ...
        )
        {
            ...
            {
                return DatabaseTestData.CreateDatabaseFieldDefinitionSettingsType2();
            }
            ...
            return DatabaseTestData.CreateDatabaseFieldDefinitionSettingsType1(index);
        }
