...
{
    [TestFixture]
    public class DatabaseDataTableWithDataNamingDefinitionListTest : TestFixtureBase
    {
        [SetUp]
        ...
        public static void MaxCapacityTest()
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseDataTableWithDataNamingDefinitionList.MaxCapacity,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseDataTableWithDataNamingDefinitionList.MinCapacity,
        ...
        public static void ConstructorTest_NoParam_Success()
        {
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseDataTableWithDataNamingDefinitionList(),
                instanceVerifier: ValueVerifier<DatabaseDataTableWithDataNamingDefinitionList>.AreItemEquals(
        ...
        public static void ConstructorTest_SettingsDto_Success()
        {
            ...
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseDataTableWithDataNamingDefinitionList(settings),
                instanceVerifier: ValueVerifier<DatabaseDataTableWithDataNamingDefinitionList>.AreItemEquals(settings)
            );
        }
        ...
        {
            IDatabaseDataTableWithDataNamingDefinitionListSettings settings = null!;
        ...
        {
            var left = new DatabaseDataTableWithDataNamingDefinitionList(CreateSettingsDto());
            IDatabaseDataTableWithDataNamingDefinitionListSettings right = left;
        ...
        {
            var left = new DatabaseDataTableWithDataNamingDefinitionList(CreateSettingsDto());
            IDatabaseDataTableWithDataNamingDefinitionListSettings right = CreateSettingsDto();
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: true
        ...
        {
            var left = new DatabaseDataTableWithDataNamingDefinitionList(CreateSettingsDto());
            IDatabaseDataTableWithDataNamingDefinitionListSettings? right = null;
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var left = new DatabaseDataTableWithDataNamingDefinitionList(CreateSettingsDto());
            IDatabaseDataTableWithDataNamingDefinitionListSettings right = CreateSettingsDto(hasNullItem: true);
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var instance = new DatabaseDataTableWithDataNamingDefinitionList(CreateSettingsDto());
        ...
        public static void SettingsDtoConstructorTest_Success_NoParam()
        {
            constructorTestHelper.ConstructorSuccess(
                () => new DatabaseDataTableWithDataNamingDefinitionListSettings(),
                instanceVerifier: new ValueVerifier<DatabaseDataTableWithDataNamingDefinitionListSettings>(instance =>
                    {
                        // 要素数が最小であること
                        Assert.AreEqual(
        ...
        /// </param>
        /// <returns></returns>
        private static DatabaseDataTableWithDataNamingDefinitionListSettings CreateSettingsDto(
            int itemLength = 4,
        ...
        /// </param>
        /// <returns></returns>
        private static IDatabaseDataTableWithDataNamingDefinitionSettings CreateSettingsItem(
            int index,
        ...
        )
        {
            ...
            {
                return DatabaseTestData.CreateDatabaseDataTableWithDataNamingDefinitionSettingsType2();
            }
            ...
            return DatabaseTestData.CreateDatabaseDataTableWithDataNamingDefinitionSettingsType1(typeId: index % 100);
        }
