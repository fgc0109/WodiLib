...
{
    [TestFixture]
    public class DatabaseFieldMetadataListTest : TestFixtureBase
    {
        [SetUp]
        ...
        public static void MaxCapacityTest()
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseFieldMetadataList.MaxCapacity,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseFieldMetadataList.MinCapacity,
        ...
        public static void ConstructorTest_NoParam_Success()
        {
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseFieldMetadataList(),
                instanceVerifier: ValueVerifier<DatabaseFieldMetadataList>.AreItemEquals(
        ...
        public static void ConstructorTest_SettingsDto_Success()
        {
            ...
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseFieldMetadataList(settings),
                instanceVerifier: ValueVerifier<DatabaseFieldMetadataList>.AreItemEquals(settings)
            );
        }
        ...
        {
            IDatabaseFieldMetadataListSettings settings = null!;
        ...
        {
            var left = new DatabaseFieldMetadataList(CreateSettingsDto());
            IDatabaseFieldMetadataListSettings right = left;
        ...
        {
            var left = new DatabaseFieldMetadataList(CreateSettingsDto());
            IDatabaseFieldMetadataListSettings right = CreateSettingsDto();
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: true
        ...
        {
            var left = new DatabaseFieldMetadataList(CreateSettingsDto());
            IDatabaseFieldMetadataListSettings? right = null;
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var left = new DatabaseFieldMetadataList(CreateSettingsDto());
            IDatabaseFieldMetadataListSettings right = CreateSettingsDto(hasNullItem: true);
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var instance = new DatabaseFieldMetadataList(CreateSettingsDto());
        ...
        public static void SettingsDtoConstructorTest_Success_NoParam()
        {
            constructorTestHelper.ConstructorSuccess(
                () => new DatabaseFieldMetadataListSettings(),
                instanceVerifier: new ValueVerifier<DatabaseFieldMetadataListSettings>(instance =>
                    {
                        // 要素数が最小であること
                        Assert.AreEqual(DatabaseFieldMetadataList.MinCapacity, instance.Settings.Count);
                    }
                )
            );
        }
        ...
        /// </param>
        /// <returns></returns>
        private static DatabaseFieldMetadataListSettings CreateSettingsDto(
            int itemLength = 4,
        ...
        /// </param>
        /// <returns></returns>
        private static IDatabaseFieldMetadataSettings CreateSettingsItem(
            int index,
        ...
        )
        {
            ...
            {
                return DatabaseTestData.CreateDatabaseFieldMetadataSettingsType2();
            }
            ...
            return DatabaseTestData.CreateDatabaseFieldMetadataSettingsType1(index);
        }
