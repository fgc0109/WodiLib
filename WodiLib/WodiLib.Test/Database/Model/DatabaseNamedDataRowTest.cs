...
{
    [TestFixture]
    public class DatabaseNamedDataRowTest : TestFixtureBase
    {
        [SetUp]
        ...
        public static void MaxCapacityTest()
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseNamedDataRow.MaxCapacity,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseNamedDataRow.MinCapacity,
        ...
        /// <summary>
        ///     プロパティ DataName の取得・編集に成功すること。
        /// </summary>
        [Test]
        public static void DataNameGetAndSetTest_Success()
        {
            var instance = new DatabaseNamedDataRow();
            DataName setItem = "TestDataName";

            propertyTestHelper.PropertyGetAndSetSuccess(
                instance,
                propertyName: nameof(DatabaseNamedDataRow.DataName),
                setItem,
                isValueEqualsBefore: false,
                setter: (x, v) => x.DataName = v,
                getter: x => x.DataName,
        ...
        /// <summary>
        ///     プロパティ DataName に null を設定した場合、
        ///     PropertyNullException が発生すること。
        /// </summary>
        [Test]
        public static void DataNameSetTest_Failure_PropertyNullException()
        {
            var instance = new DatabaseNamedDataRow();

            propertyTestHelper.PropertySetFailure(
                instance,
                setItem: (DataName)null!,
                setter: (x, v) => x.DataName = v,
        ...
        public static void ConstructorTest_NoParam_Success()
        {
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseNamedDataRow(),
                instanceVerifier: ValueVerifier<DatabaseNamedDataRow>.AreItemEquals(new DatabaseNamedDataRowSettings())
            );
        }
        ...
        public static void ConstructorTest_SettingsDto_Success()
        {
            ...
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseNamedDataRow(settings),
                instanceVerifier: ValueVerifier<DatabaseNamedDataRow>.AreItemEquals(settings)
            );
        }
        ...
        {
            IDatabaseNamedDataRowSettings settings = null!;
        ...
        ///     ArgumentException が発生すること。
        /// </summary>
        [TestCase(nameof(DatabaseNamedDataRowSettings.DataName))]
        public static void ConstructorTest_SettingsDto_Failure_HasNullProperty(string propertyName)
        {
            var settings = CreateSettingsDto(nullProperty: propertyName);
            constructorTestHelper.ConstructorFailure(
                factory: () => new DatabaseNamedDataRow(settings),
                exceptionVerifier: ExceptionVerifier.IsType(typeof(ArgumentException))
            );
        ...
        {
            var left = new DatabaseNamedDataRow(CreateSettingsDto());
            IDatabaseNamedDataRowSettings right = left;
        ...
        {
            var left = new DatabaseNamedDataRow(CreateSettingsDto());
            IDatabaseNamedDataRowSettings right = CreateSettingsDto();
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: true
        ...
        {
            var left = new DatabaseNamedDataRow(CreateSettingsDto());
            IDatabaseNamedDataRowSettings? right = null;
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var left = new DatabaseNamedDataRow(CreateSettingsDto());
            IDatabaseNamedDataRowSettings right = CreateSettingsDto(hasNullItem: true);
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        /// </summary>
        [TestCase(nameof(DatabaseNamedDataRowSettings.DataName))]
        public static void ItemEqualsTest_Settings_False_DiffProperty(string replaceProperty)
        {
            var left = new DatabaseNamedDataRow(CreateSettingsDto());
            IDatabaseNamedDataRowSettings right = CreateSettingsDto(replaceProperty: replaceProperty);
            itemEqualsTestHelper.ItemEquals(
                left,
                right,
                expected: false
        ...
        {
            var instance = new DatabaseNamedDataRow(CreateSettingsDto());
        ...
        public static void SettingsDtoConstructorTest_Success_NoParam()
        {
            constructorTestHelper.ConstructorSuccess(
                ...
                instanceVerifier: new ValueVerifier<DatabaseNamedDataRowSettings>(instance =>
                    {
                        // 要素数が最小であること
                        Assert.AreEqual(DatabaseNamedDataRow.MinCapacity, instance.Settings.Count);
                    }
                )
            );
        }
        ...
        /// </param>
        /// <returns></returns>
        private static DatabaseNamedDataRowSettings CreateSettingsDto(
            int itemLength = 4,
        ...
        )
        {
            ...
            {
                DataName = (nullProperty == nameof(DatabaseNamedDataRowSettings.DataName),
                        replaceProperty == nameof(DatabaseNamedDataRowSettings.DataName)) switch
                    {
                        // null?  replace?  setValue
                        (false, false) => "DataName1",
                        (false, true) => "DataName2",
                        (true, _) => null!,
                    },
            };
        }
