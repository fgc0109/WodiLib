...
{
    [TestFixture]
    public class UserDatabaseAddressExtensionTest : TestFixtureBase
    {
        [SetUp]
        ...
        [TestCase(1000000102, 0)]
        [TestCase(1024012345, 24)]
        public static void GetTypeIdTest_Success(int src, int expected)
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => UserDatabaseAddressExtension.GetTypeId(src),
        ...
        public static void GetTypeIdTest_Failure_ArgumentNull()
        {
            staticFunctionTestHelper.StaticFuncFailure(
                execFunc: () => UserDatabaseAddressExtension.GetTypeId(null!),
        ...
        /// <param name="src">取得元</param>
        /// <param name="expected">期待する値</param>
        [TestCase(1000000102, 1)]
        [TestCase(1024012345, 123)]
        public static void GetDataIdTest_Success(int src, int expected)
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => UserDatabaseAddressExtension.GetDataId(src),
        ...
        {
            staticFunctionTestHelper.StaticFuncFailure(
                execFunc: () => UserDatabaseAddressExtension.GetDataId(null!),
                exceptionVerifier: ExceptionVerifier.IsType(typeof(ArgumentNullException))
            );
        }
        ...
        /// <param name="src">取得元</param>
        /// <param name="expected">期待する値</param>
        [TestCase(1000000102, 2)]
        [TestCase(1024012345, 45)]
        public static void GetFieldIdTest_Success(int src, int expected)
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => UserDatabaseAddressExtension.GetFieldId(src),
        ...
        {
            staticFunctionTestHelper.StaticFuncFailure(
                execFunc: () => UserDatabaseAddressExtension.GetFieldId(null!),
                exceptionVerifier: ExceptionVerifier.IsType(typeof(ArgumentNullException))
            );
        }
