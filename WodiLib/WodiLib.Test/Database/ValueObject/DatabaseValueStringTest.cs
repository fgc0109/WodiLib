...
{
    [TestFixture]
    public class DatabaseValueStringTest : TestFixtureBase
    {
        [SetUp]
        ...
        public static void ConstructorStringTest_Success(string value)
        {
            constructorTestHelper.ConstructorSuccess(
                factory: () => new DatabaseValueString(value),
                instanceVerifier: new ValueVerifier<DatabaseValueString>(instance =>
                    {
        ...
        public static void ConstructorStringTest_Failure_NullArgs()
        {
            constructorTestHelper.ConstructorFailure(
                factory: () => new DatabaseValueString(null!),
        ...
        {
            var instance1 = new DatabaseValueString("a");
            var instance2 = new DatabaseValueString("a");
            var instance3 = new DatabaseValueString("aa");
        ...
        public static void ToStringTest_Success()
        {
            ...
            pureFunctionTestHelper.PureFuncSuccess(
                instance: new DatabaseValueString(value),
        ...
        /// <summary>
        ///     string から DatabaseValueString に暗黙的型変換できること。
        /// </summary>
        [Test]
        public static void CastStringToDatabaseValueStringTest_Success()
        {
            const string value = "abc";
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => value,
                resultValueVerifier: ValueVerifier<DatabaseValueString>.AreEquals(value)
            );
        }
        ...
        /// <summary>
        ///     DatabaseValueString から string に暗黙的型変換できること。
        /// </summary>
        [Test]
        public static void CastDatabaseValueStringToStringTest_Success()
        {
            const string value = "abc";
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => new DatabaseValueString(value),
                resultValueVerifier: ValueVerifier.AreEquals(value)
            );
        }
        ...
        {
            var leftValue = (DatabaseValueString?)left;
            var rightValue = (DatabaseValueString?)right;
        ...
        [TestCase("a", "b", false)]
        [TestCase("a", null, false)]
        public static void EqualsTest_DatabaseValueString(string left, string? right, bool expected)
        {
            var leftValue = (DatabaseValueString)left;
            var rightValue = (DatabaseValueString?)right;
        ...
        {
            // [left, right, expected]
            new object?[] { "abc", new DatabaseValueString("abc"), true },
            new object?[] { "abc", new DatabaseValueString("cba"), false },
