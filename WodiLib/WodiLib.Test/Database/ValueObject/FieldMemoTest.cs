...
{
    [TestFixture]
    public class FieldMemoTest : TestFixtureBase
    {
        [SetUp]
        ...
        public static void ConstructorStringTest_Success(string value)
        {
            constructorTestHelper.ConstructorSuccess(
                factory: () => new FieldMemo(value),
                instanceVerifier: new ValueVerifier<FieldMemo>(instance =>
                    {
        ...
        {
            var instance1 = new FieldMemo("a");
            var instance2 = new FieldMemo("a");
            var instance3 = new FieldMemo("aa");
        ...
        /// <summary>
        ///     string から FieldMemo に暗黙的型変換できること。
        /// </summary>
        [Test]
        public static void CastStringToFieldMemoTest_Success()
        {
            const string value = "abc";
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => value,
                resultValueVerifier: ValueVerifier<FieldMemo>.AreEquals(value)
            );
        }
        ...
        /// <summary>
        ///     FieldMemo から string に暗黙的型変換できること。
        /// </summary>
        [Test]
        public static void CastFieldMemoToStringTest_Success()
        {
            const string value = "abc";
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => new FieldMemo(value),
                resultValueVerifier: ValueVerifier.AreEquals(value)
            );
        }
        ...
        {
            var leftValue = (FieldMemo?)left;
            var rightValue = (FieldMemo?)right;
        ...
        [TestCase("a", "b", false)]
        [TestCase("a", null, false)]
        public static void EqualsTest_FieldMemo(string left, string? right, bool expected)
        {
            var leftValue = (FieldMemo)left;
            var rightValue = (FieldMemo?)right;
        ...
        {
            // [left, right, expected]
            new object?[] { "abc", new FieldMemo("abc"), true },
            new object?[] { "abc", new FieldMemo("cba"), false },
