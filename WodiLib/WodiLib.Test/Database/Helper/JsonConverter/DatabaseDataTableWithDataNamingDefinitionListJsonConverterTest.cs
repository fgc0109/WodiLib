...
{
    [TestFixture]
    public class DatabaseDataTableWithDataNamingDefinitionListJsonConverterTest : TestFixtureBase
    {
        [SetUp]
        ...
        {
            var instance = new DatabaseDataTableWithDataNamingDefinitionList(
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => JsonSerializer.Deserialize<DatabaseDataTableWithDataNamingDefinitionList>(
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => JsonSerializer.Deserialize<FixedDatabaseDataTableWithDataNamingDefinitionList>(
                    SerializeTestItem.JsonText,
                    new JsonSerializerOptions
                    {
                        PropertyNamingPolicy = JsonNamingPolicy.SnakeCaseLower,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => JsonSerializer.Deserialize<ReadOnlyDatabaseDataTableWithDataNamingDefinitionList>(
                    SerializeTestItem.JsonText,
                    new JsonSerializerOptions
                    {
                        PropertyNamingPolicy = JsonNamingPolicy.SnakeCaseLower,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => JsonSerializer.Deserialize<DatabaseDataTableWithDataNamingDefinitionListSettings>(
                    SerializeTestItem.JsonText,
                    new JsonSerializerOptions
                    {
                        PropertyNamingPolicy = JsonNamingPolicy.SnakeCaseLower,
        ...
        {
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => JsonSerializer.Deserialize<IDatabaseDataTableWithDataNamingDefinitionListSettings>(
                    SerializeTestItem.JsonText,
                    new JsonSerializerOptions
                    {
                        PropertyNamingPolicy = JsonNamingPolicy.SnakeCaseLower,
        ...
        private static class SerializeTestItem
        {
            ...
            public static readonly IDatabaseDataTableWithDataNamingDefinitionListSettings Settings =
