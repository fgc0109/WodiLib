...
{
    [TestFixture]
    public class DatabaseNamedDataRowBinarySerializerTest : TestFixtureBase
    {
        [SetUp]
        ...
        {
            var src = new DatabaseNamedDataRow(
            ...
            staticFunctionTestHelper.StaticFuncSuccess(
                execFunc: () => DatabaseNamedDataRowBinarySerializer.SerializeValuesDividedType(src)
            );
