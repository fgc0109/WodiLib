...
namespace WodiLib.Sys
{
    ...
    internal static class ListExtension
    {
        ...
        /// <param name="length">
        ///     [Range(1, int.MaxValue)] 調整する長さ
        /// </param>
        /// <param name="makeDefaultItemFunc">要素数を増やす場合にデフォルトで設定する値を返すメソッド</param>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="makeDefaultItemFunc"/> が <see langword="null"/> の場合。
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     <paramref name="makeDefaultItemFunc"/> が <see langword="null"/> を返却する場合。
        /// </exception>
