...
// File Name    : DatabaseNamedDataTableBinarySerializer.cs
//
...
{
    /// <summary>
    ///     <see cref="ReadOnlyDatabaseNamedDataTable"/> およびその列挙をバイナリ配列に変換するためのHelperクラス
    /// </summary>
    internal static class DatabaseNamedDataTableBinarySerializer
    {
        ...
        public static byte[] SerializeValuesDividedType(this ReadOnlyDatabaseNamedDataTable src)
