...
namespace WodiLib.SourceGenerator.Domain.JsonConverter.Generation
{
    /// <summary>
    ///     JsonConverterSourceGenerator用定数クラス
    /// </summary>
    internal static class GenerationConst
    {
        /// <summary>ルート名前空間</summary>
        private static string RootNameSpace => $"{Core.Generation.GenerationConst.RootNameSpace}.JsonConverter";
