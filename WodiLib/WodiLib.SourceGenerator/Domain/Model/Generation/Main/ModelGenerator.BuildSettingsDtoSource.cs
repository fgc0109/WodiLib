...
// File Name    : ModelGenerator.BuildSettingsDtoSource.cs
//
...
namespace WodiLib.SourceGenerator.Domain.Model.Generation.Main
{
    ...
    {
        private static SourceFormatTargetBlock BuildSettingsDtoSource(
        ...
        )
        {
            ...
            return SourceTextFormatter.Format(
                ...
                new[]
                {
                    ...
                    $"/// </summary>",
                    $"{modelInfo.Accessibility} {modelInfo.AbstractKeyword}partial record {modelInfo.SettingsDtoInfo.SettingsDtoName} : {modelInfo.SettingsDtoInfo.ExtendsSettingsDto}",
                    $"{{",
                },
