...
// File Name    : FixedLengthListImplementTemplateAttribute.cs
//
...
namespace WodiLib.SourceGenerator.Domain.Collection.Generation.PostInitAction.Attributes
{
    ...
    /// </summary>
    internal class FixedLengthListImplementTemplateAttribute : InitializeAttributeSourceAddable
    {
        /// <inheritdoc/>
        public override string AttributeName => nameof(FixedLengthListImplementTemplateAttribute);
        ...
        public static FixedLengthListImplementTemplateAttribute Instance { get; } = new();
    }
}
