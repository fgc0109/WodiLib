...
// File Name    : FixedLength2DListImplementTemplateAttribute.cs
//
...
namespace WodiLib.SourceGenerator.Domain.Collection.Generation.PostInitAction.Attributes
{
    ...
    /// </summary>
    internal class FixedLength2DListImplementTemplateAttribute : InitializeAttributeSourceAddable
    {
        /// <inheritdoc/>
        public override string AttributeName => nameof(FixedLength2DListImplementTemplateAttribute);
        ...
        public static FixedLength2DListImplementTemplateAttribute Instance { get; } = new();
    }
}
