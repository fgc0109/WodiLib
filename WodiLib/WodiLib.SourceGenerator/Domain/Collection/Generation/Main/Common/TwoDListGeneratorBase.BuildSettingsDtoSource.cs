...
// File Name    : TwoDListGeneratorBase.BuildSettingsDtoSource.cs
//
        ...
        private static SourceFormatTargetBlock BuildSettingsDtoSource(ModelInformation modelInfo)
        {
            ...
            return SourceTextFormatter.Format(
                ...
                new[]
                {
                    ...
                    $"/// </summary>",
                    $"{modelInfo.Accessibility} {modelInfo.AbstractKeyword}partial record {modelInfo.SettingsDtoInfo.SettingsDtoName}(IReadOnlyList<{modelInfo.RowSettingsType}> Settings) : {modelInfo.SettingsDtoInfo.ExtendsSettingsDto}",
                    $"{{",
                },
