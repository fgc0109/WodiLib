        ...
        private static SourceFormatTargetBlock BuildSettingsDtoSource(ModelInformation modelInfo)
        {
            ...
            return SourceTextFormatter.Format(
                ...
                new[]
                {
                    ...
                    $"/// </summary>",
                    $"{modelInfo.Accessibility} {modelInfo.AbstractKeyword}partial record {modelInfo.SettingsDtoInfo.SettingsDtoName}(IList<{modelInfo.RowSettingsType}> Settings) : {modelInfo.SettingsDtoInfo.ExtendsSettingsDto}",
                    $"{{",
                },
